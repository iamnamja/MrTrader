# External Quant Review - MrTrader System (2026-06-10) (Grok)
...
2. **Dispersion trading (index vs single-stock vol) - relative VRP.**
   ...
   Test: OPT-4b extension. Stress 2-3x spreads. Book-level contribution (add small sleeve to PEAD+trend). Kill if no residual alpha after beta-hedging.
...
- **No sacred holdout.** CPCV is strong but no final untouched period post all research. Risk of meta-overfitting. [NOTE: app does reserve a forward sacred holdout 2026-11-09.]
