...
| **A2** | **Short-interest / squeeze edge** — squeeze event table (high days-to-cover + SI build, or short-volume-ratio z-spike) → drift measured forward → CPCV + event-bootstrap → verdict. Needs A0. | ~2d + compute | After A0/A1 |
