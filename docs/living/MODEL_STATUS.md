...
> **UPDATE (2026-05-31, #DAILYPROV — daily-feature data-quality fix):** ANY intraday per-fold (or
...
> daily features were blinded). #DAILYPROV routes the daily fetch through `INTRADAY_DAILY_FEATURE_PROVIDER`
