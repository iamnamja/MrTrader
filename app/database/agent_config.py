...
CONFIG_SCHEMA: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "min": 1.0,
        "max": 10.0,
        "description": "B4 paper-ramp: multiply PEAD per-name position size by this (3.0 = aggressive 3x to stress capacity). Live-tunable; 1.0 = pre-ramp sizing. PAPER ONLY.",
        "group": "Portfolio Manager",
    },
    {
        ...
        "min": 0.01,
        "max": 0.25,
        "description": "B4 paper-ramp: per-name ceiling for PEAD positions as a fraction of account value (0.10 = 10% NAV). Caps the ramped size. PAPER ONLY.",
        "group": "Portfolio Manager",
    },
    {
