...
SP_500_TICKERS = [
    ...
    "INTU", "MSCI", "FSLR", "HPQ", "HPE", "WDC", "STX", "NTAP", "CSCO",
    ...
    "MLM", "VMC", "SUM", "EXP",
    # Real Estate
    "AMT", "PLD", "CCI", "EQIX", "WELL", "VTR", "DOC", "HR",
    "O", "NNN", "ADC", "EPRT",
    "SPG", "MAC", "SKT",
    "EXR", "CUBE", "PSA",
    "EQR", "AVB", "ESS", "MAA", "UDR", "CPT",
    "BXP", "VNO", "SLG", "KRC", "DEI", "VRE",
    "DLR", "COR",
    # Utilities
...
SECTOR_MAP = {
    ...
    "STX": "Technology", "NTAP": "Technology",
    ...
    "GIS": "Consumer Staples", "CPB": "Consumer Staples",
    ...
    "RSG": "Industrials", "CLH": "Industrials",
    ...
    "KRC": "Real Estate", "DEI": "Real Estate", "VRE": "Real Estate",
    "DLR": "Real Estate", "COR": "Real Estate",
    # Utilities
